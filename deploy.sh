...
echo "[2/4] Đảm bảo mật khẩu PostgreSQL container đồng bộ..."
docker exec -i crm_namkhanh_postgres psql -U postgres -c "ALTER USER postgres WITH PASSWORD '123456';" || true
