...
echo 1. Khoi dong CSDL PostgreSQL & Redis (Docker Compose)...
docker-compose up -d

echo 2. Khoi dong Backend API (Port 5000)...
start "NK Nam Khanh - Backend API (5000)" cmd /k "pushd "%~dp0backend" && npm run start:dev"

echo 3. Doi 3 giay de Backend san sang...
timeout /t 3 /nobreak > nul

echo 4. Khoi dong Frontend Web App (Port 3000)...
